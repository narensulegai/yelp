...
[
  ...
  ['get', '/mongo/comments/:id', mongoHandler.getComments, null],
  ...
  ['get', '/mongo/restaurant/comments', mongoHandler.getRestaurantComments, 'restaurant', null],
  ['get', '/api/restaurant/dishes/:id', handler.getRestaurantDishes, null],
  ['get', '/mongo/restaurant/dishes/:id', mongoHandler.getRestaurantDishes, null],
  ['post', '/api/placeOrder/:id', handler.placeOrder, 'customer'],
  ['post', '/mongo/placeOrder/:id', mongoHandler.placeOrder, 'customer'],
  ['get', '/api/myOrders', handler.myOrders, 'any'],
  ['get', '/mongo/myOrders', mongoHandler.myOrders, 'any'],
  ['put', '/api/myOrder/:id', handler.updateMyOrder, 'any'],
  ['put', '/mongo/myOrder/:id', mongoHandler.updateMyOrder, 'any'],
  ['get', '/api/customer/:id', handler.getCustomer, null],
  ['get', '/mongo/customer/:id', mongoHandler.getCustomer, null],
